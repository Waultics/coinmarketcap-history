...
def getDataFor(cryptocurrencies, start_date, end_date, fields = [], use_async = False, DOWNLOAD_DIR = None):
    ...
    if use_async:
        ...
        from cmc.async_utils import async_utils
...
parser.add_argument("end_date",    help="End date for the historical data retrieval. If you wish to retrieve all the "
                                        ...
                                        "'yyyy-mm-dd'.", type=str)
parser.add_argument("--use-async", help="If present, scrapes cryptocurrencies asynchronously (faster).", default=False, action='store_true')
...
def main(args=None):
    ...
    cryptocurrencies, start_date, end_date, use_async = args.currency, args.start_date, args.end_date, args.use_async

    cryptocurrencies = cryptocurrencies.split(',')

    df = getDataFor(cryptocurrencies, start_date, end_date, use_async=use_async)
